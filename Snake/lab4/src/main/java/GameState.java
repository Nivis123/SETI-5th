...
public class GameState {
    ...
    public int addNewPlayer(String playerName, InetSocketAddress sender, SnakesProto.NodeRole requestedRole) {
        int playerId = counterPlayers.getAndIncrement();
